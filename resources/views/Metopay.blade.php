                        ...
                        <div class="card-body">
                            <div class="card-body">
                                <form method="POST" action="{{ route('login') }}">
                                    <form>
                                        <img src="https://cdn-icons-png.flaticon.com/512/4564/4564877.png" class="img-fluid" alt="Imagen metodo de pago">
                                        <div class="mb-3">
                                          <label for="InputClave" class="form-label">Numeros de tarjeta</label>
                                          <input type="Clave" class="form-control" id="InputClave" placeholder='4353-3344-6764-****' >
                                        ...
                                        <div class="mb-3">
                                          ...
                                          <input type="password" class="form-control" id="InputPassword" placeholder='AA//MM'>
                                        </div>
                                        <div class="mb-3">
                                        ...
                                        <div class="mb-3 form-check">
                                          ...
                                          <label class="form-check-label" for="exampleCheck1">Aceptar termino y condiciones</label>
                                        </div>
